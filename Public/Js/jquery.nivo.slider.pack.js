...
(function(a) {
    var b = function(b, c) {
        ...
        if (a(g[e.currentSlide]).is("a")) {
            a(g[e.currentSlide]).css("display", "hidden")
        }
        f.css("background", 'url("' + e.currentImage.attr("src") + '") no-repeat');
        f.append(a('<div class=""><p></p></div>').css({
            display: "none",
        ...
        var o = function(b, c, d, e) {
            ...
            $("#Indexbanner.nivoSlider").css("cursor","pointer");
            $("#Indexbanner.nivoSlider").click(function(){
                    var tiaozhuan = $(this);
                    $(".nivo-controlNav a").each(function(){
                            var xclas = $(this).attr("class");
                            if(xclas.indexOf("active") > 0){
                                    var index = $(this).attr("rel");
                                    // console.log(tiaozhuan.children("a").eq(index).attr("href"));
                                    window.location.href = tiaozhuan.children("a").eq(index).attr("href");
                            }
                    });
            });
        ...
        function() {
            ...
            if (a(g[e.currentSlide]).is("a")) {
                a(g[e.currentSlide]).css("display", "none")
            }
